...
(function() {
  var Lexer, SourceMap, base64encode, compile, ext, fn1, fs, getSourceMap, helpers, i, len, lexer, parser, path, ref, sourceMaps, vm, withPrettyErrors,
  ...
  getSourceMap = function(filename) {
    ...
    return sourceMaps[filename] = answer.v3SourceMap;
  };

  require('source-map-support').install({
    retrieveSourceMap: function(filename) {
      var map;
      map = getSourceMap(filename);
      if (map) {
        return {
          url: filename,
          map: getSourceMap(filename)
